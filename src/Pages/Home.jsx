...
const WORDS = ["Full Stack Developer","Quick Learner" , "Problem Solving", "Tech Enthusiast"];
const TECH_STACK = ["HTML", "CSS", "Javascript", "Java", "Spring Boot", "My SQL", "Git", "UI Design", "PHP"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Arunkutty06" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/arunmdr/" },
  { icon: Code2, link: "https://leetcode.com/u/gHQ75zUSRm/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  A passinate in frontend development & UI / UX
                </p>
